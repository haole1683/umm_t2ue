...
if(__name__ == "__main__"):    
    ...
    options.train_data = os.path.abspath(options.train_data)
    options.eval_test_data_dir = os.path.abspath(options.eval_test_data_dir)
    ...
    print("The path is ", options.log_dir_path)
