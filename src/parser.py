...
def parse_args():
    ...
    parser.add_argument("--device", type = str, default = "gpu", choices = ["cpu", "gpu"], help = "Specify device type to use (default: gpu > cpu)")
    ...
    parser.add_argument("--save_pert",  default=None, help="pert path name")
    parser.add_argument("--init_pert",  default=None, help="pert path name")
    parser.add_argument("--token_num",type = int, default=3, help="token words number")
    parser.add_argument("--class_num",type = int, default=1000, help="token words number")
    parser.add_argument("--epsilon",type = int, default=8, help="token words number")
    parser.add_argument("--face", default=None, help="token words number")
    
    parser.add_argument("--noise_path", default=None, help="my generator noise path")
